...
function cargarItemsCabina() {
    ...
    var valor_options_radio = 1;
    db.transaction(function (tx) {
        var query = "SELECT k_coditem_cabina, v_item, o_descripcion, v_clasificacion FROM ascensor_items_cabina";
        tx.executeSql(query, [], function (tx, resultSet) {
            for(var x = 0; x < resultSet.rows.length; x++) {
                        ...
                        '<div class="col-xs-4 col-sm-4 col-md-4" style="border-top:1px solid;">'+
                            '<div class="radio">'+
                                '<label for="sele_lv_cabina'+valor_options_radio+'" style="width: 100%;">'+
                                    '<input type="radio" name="sele_cabina'+valor_seleval+'" id="sele_lv_cabina'+valor_options_radio+'" value="Si Cumple" checked>'+
                                '</label>'+
                            '</div>'+
                        '</div>';
                        valor_options_radio += 1;
                        ...
                        '<div class="col-xs-4 col-sm-4 col-md-4" style="border-top:1px solid;">'+
                            '<div class="radio">'+
                                '<label for="sele_lv_maquinas'+valor_options_radio+'" style="width: 100%;">'+
                                    '<input type="radio" name="sele_maquinas'+valor_seleval+'" id="sele_lv_maquinas'+valor_options_radio+'" value="Si Cumple" checked>'+
                                '</label>'+
                            '</div>'+
                        '</div>';
                        valor_options_radio += 1;
...
function cargarItemsPozo() {
    ...
    var valor_options_radio = 1;
    db.transaction(function (tx) {
        var query = "SELECT k_coditem_pozo, v_item, o_descripcion, v_clasificacion FROM ascensor_items_pozo";
        tx.executeSql(query, [], function (tx, resultSet) {
            for(var x = 0; x < resultSet.rows.length; x++) {
                ...
                '<div class="container-fluid">'+
                    ...
                    '<div class="row" style="border-left:1px solid; border-right:1px solid; text-align: center;">'+
                        ...
                        '<div class="col-xs-4 col-sm-4 col-md-4" style="border-top:1px solid; border-left:1px solid;">'+
                            '<div class="radio">'+
                                '<label for="sele_lv_pozo'+valor_options_radio+'" style="width: 100%;">'+
                                    '<input type="radio" name="sele_pozo'+valor_seleval+'" id="sele_lv_pozo'+valor_options_radio+'" value="No Aplica" checked>'+
                                '</label>'+
                            '</div>'+
                        '</div>'+
                    '</div>'+
...
function cargarItemsFoso() {
    ...
    var valor_options_radio = 1;
    db.transaction(function (tx) {
        var query = "SELECT k_coditem_foso, v_item, o_descripcion, v_clasificacion FROM ascensor_items_foso";
        tx.executeSql(query, [], function (tx, resultSet) {
            for(var x = 0; x < resultSet.rows.length; x++) {
                        ...
                        '<div class="col-xs-4 col-sm-4 col-md-4" style="border-top:1px solid;">'+
                            '<div class="radio">'+
                                '<label for="sele_lv_foso'+valor_options_radio+'" style="width: 100%;">'+
                                    '<input type="radio" name="sele_foso'+valor_seleval+'" id="sele_lv_foso'+valor_options_radio+'" value="Si Cumple" checked>'+
                                '</label>'+
                            '</div>'+
                        '</div>';
                        valor_options_radio += 1;
