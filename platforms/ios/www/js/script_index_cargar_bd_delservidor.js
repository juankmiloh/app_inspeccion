...
function crearTablaAuditoriaInspeccionesAscensores(){
  db.transaction(function (tx) {
    tx.executeSql('CREATE TABLE auditoria_inspecciones_ascensores (k_codusuario,k_codinspeccion,o_consecutivoinsp,o_estado_envio,o_revision,v_item_nocumple,k_codcliente,k_codinforme,k_codusuario_modifica)');
  }, function (error) {
    console.log('transaction error: ' + error.message);
  }, function () {
...
function crearTablaAuditoriaInspeccionesPuertas(){
  db.transaction(function (tx) {
    tx.executeSql('CREATE TABLE auditoria_inspecciones_puertas (k_codusuario,k_codinspeccion,o_consecutivoinsp,o_estado_envio,o_revision,v_item_nocumple,k_codcliente,k_codinforme,k_codusuario_modifica)');
  }, function (error) {
    console.log('transaction error: ' + error.message);
  }, function () {
    $('#texto_carga').text("Creando valores auditoria...Espere");
...
function crearTablaAuditoriaInspeccionesEscaleras(){
  db.transaction(function (tx) {
    tx.executeSql('CREATE TABLE auditoria_inspecciones_escaleras (k_codusuario,k_codinspeccion,o_consecutivoinsp,o_estado_envio,o_revision,v_item_nocumple,k_codcliente,k_codinforme,k_codusuario_modifica)');
  }, function (error) {
    console.log('transaction error: ' + error.message);
  }, function () {
    $('#texto_carga').text("Creando valores auditoria...Espere");
...
function llenarTablaAscensorItemsCabina(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_ascensor_items_cabina.php";
...
function llenarTablaAscensorItemsFoso(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_ascensor_items_foso.php";
...
function llenarTablaAscensorItemsMaquinas(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_ascensor_items_maquinas.php";
...
function llenarTablaAscensorItemsPozo(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_ascensor_items_pozo.php";
...
function llenarTablaAscensorItemsPreliminar(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_ascensor_items_preliminar.php";
...
function llenarTablaAscensorItemsProteccion(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_ascensor_items_proteccion.php";
...
function llenarTablaAscensorItemsElementos(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_ascensor_items_elementos.php";
...
function llenarTablaEscalerasItemsPreliminar(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_escaleras_items_preliminar.php";
...
function llenarTablaEscalerasItemsProteccion(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_escaleras_items_proteccion.php";
...
function llenarTablaEscalerasItemsElementos(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_escaleras_items_elementos.php";
...
function llenarTablaEscalerasItemsDefectos(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_escaleras_items_defectos.php";
...
function llenarTablaPuertasItemsPreliminar(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_puertas_items_preliminar.php";
...
function llenarTablaPuertasItemsProteccion(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_puertas_items_proteccion.php";
...
function llenarTablaPuertasItemsElementos(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_puertas_items_elementos.php";
...
function llenarTablaPuertasItemsMecanicos(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_puertas_items_mecanicos.php";
...
function llenarTablaPuertasItemsElectrica(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_puertas_items_electrica.php";
...
function llenarTablaPuertasItemsManiobras(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_puertas_items_maniobras.php";
...
function llenarTablaPuertasItemsMotorizacion(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_puertas_items_motorizacion.php";
...
function llenarTablaPuertasItemsOtras(){
  var url="http://192.168.0.27:8080/inspeccion/servidor/php/json_puertas_items_otras.php";
