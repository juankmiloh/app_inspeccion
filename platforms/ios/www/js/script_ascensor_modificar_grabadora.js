...
function onCopySuccessAudio(entry) {
  ...
  addItemsAscensorValoresAudios();
  //ObtenerCantidadItemsAVA();
  //getDataAscensorValoresAudios();
...
*==============================================*/
function addItemsAscensorValoresAudios() {
...
/*=============================================
* Funcion en donde se cuentan las filas de la tabla ascensor_valores_audios [AVA]
*==============================================*/
/*function ObtenerCantidadItemsAVA(){
  db.transaction(function (tx) {
    var query = "SELECT COUNT(*) AS c FROM ascensor_valores_audios";
    tx.executeSql(query, [], function (tx, resultSet) {
      console.log('Numero de filas tabla ascensor_valores_audios -> '+resultSet.rows.item(0).c);
    },
    function (tx, error) {
...
/*=============================================
* Funcion para hacer un select a la tabla ascensor_valores_audios
*==============================================*/
/*function getDataAscensorValoresAudios() {
  db.transaction(function (tx) {
    var query = "SELECT k_codusuario,k_codinspeccion,n_audio,n_directorio FROM ascensor_valores_audios";
    tx.executeSql(query, [], function (tx, resultSet) {
