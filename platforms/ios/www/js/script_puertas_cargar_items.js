                        ...
                        '<div class="col-xs-4 col-sm-4 col-md-4" style="border-top:1px solid;">'+
                            '<div class="radio">'+
                                '<label for="sele_lv_mecanicos'+valor_options_radio+'" style="width: 100%;">'+
                                    '<input type="radio" name="sele_mecanicos'+valor_seleval+'" id="sele_lv_mecanicos'+valor_options_radio+'" value="Si Cumple" checked>'+
                                '</label>'+
                            '</div>'+
                        '</div>';
                        valor_options_radio += 1;
                        ...
                        '<div class="col-xs-4 col-sm-4 col-md-4" style="border-top:1px solid;">'+
                            '<div class="radio">'+
                                '<label for="sele_lv_electrica'+valor_options_radio+'" style="width: 100%;">'+
                                    '<input type="radio" name="sele_electrica'+valor_seleval+'" id="sele_lv_electrica'+valor_options_radio+'" value="Si Cumple" checked>'+
                                '</label>'+
                            '</div>'+
                        '</div>';
                        valor_options_radio += 1;
                        ...
                        '<div class="col-xs-4 col-sm-4 col-md-4" style="border-top:1px solid;">'+
                            '<div class="radio">'+
                                '<label for="sele_lv_motorizacion'+valor_options_radio+'" style="width: 100%;">'+
                                    '<input type="radio" name="sele_motorizacion'+valor_seleval+'" id="sele_lv_motorizacion'+valor_options_radio+'" value="Si Cumple" checked>'+
                                '</label>'+
                            '</div>'+
                        '</div>';
                        valor_options_radio += 1;
                        ...
                        '<div class="col-xs-4 col-sm-4 col-md-4" style="border-top:1px solid;">'+
                            '<div class="radio">'+
                                '<label for="sele_lv_otras'+valor_options_radio+'" style="width: 100%;">'+
                                    '<input type="radio" name="sele_otras'+valor_seleval+'" id="sele_lv_otras'+valor_options_radio+'" value="Si Cumple" checked>'+
                                '</label>'+
                            '</div>'+
                        '</div>';
                        valor_options_radio += 1;
                        ...
                        '<div class="col-xs-4 col-sm-4 col-md-4" style="border-top:1px solid;">'+
                            '<div class="radio">'+
                                '<label for="sele_lv_maniobras'+valor_options_radio+'" style="width: 100%;">'+
                                    '<input type="radio" name="sele_maniobras'+valor_seleval+'" id="sele_lv_maniobras'+valor_options_radio+'" value="Si Cumple" checked>'+
                                '</label>'+
                            '</div>'+
                        '</div>';
                        valor_options_radio += 1;
