...
function onCopySuccessPhoto(entry) {
  ...
  //getDataAscensorValoresFotografias();
...
*==============================================*/
function addItemsAscensorValoresFotografias() {
...
/*=============================================
* Funcion en donde se cuentan las filas de la tabla ascensor_valores_fotografias [AVF]
*==============================================*/
/*function ObtenerCantidadItemsAVF(){
  db.transaction(function (tx) {
    var query = "SELECT COUNT(*) AS c FROM ascensor_valores_fotografias";
    tx.executeSql(query, [], function (tx, resultSet) {
      console.log('Numero de filas tabla ascensor_valores_fotografias -> '+resultSet.rows.item(0).c);
    },
    function (tx, error) {
...
/*=============================================
* Funcion para hacer un select a la tabla ascensor_valores_fotografias
*==============================================*/
/*function getDataAscensorValoresFotografias() {
  db.transaction(function (tx) {
    var query = "SELECT k_codusuario,k_codinspeccion,k_coditem,n_fotografia,n_directorio FROM ascensor_valores_fotografias";
    tx.executeSql(query, [], function (tx, resultSet) {
