$(document).ready(function($){
  ...
  Concurrent.Thread.create(obtenerCantidadInspeccionesPendientesAscensores); //Ejecutamos de manera concurrente la funcion de cargar las inspecciones a ascensores
  Concurrent.Thread.create(obtenerCantidadInspeccionesPendientesPuertas); //Ejecutamos de manera concurrente la funcion de cargar las inspecciones a ascensores
  Concurrent.Thread.create(obtenerCantidadInspeccionesPendientesEscaleras); //Ejecutamos de manera concurrente la funcion de cargar las inspecciones a ascensores
...
function onBackKeyDown(e) {
  e.preventDefault();
  message = 'Advertencia: Se perderan los cambios realizados.\n\n¿Desea volver al menú principal?';
...
function obtenerCantidadInspeccionesPendientesAscensores(){
  db.transaction(function (tx) {
    ...
    function (tx, error) {
      console.log('SELECT error: ' + error.message);
      if(navigator.notification && navigator.notification.alert){
        navigator.notification.alert("No tiene inspecciones pendientes!", null, "Montajes & Procesos M.P SAS", "Ok");
        window.location='../index.html';
      }else{
        //alert("No tiene inspecciones pendientes para subir al servidor!");
        //window.location='../index.html';
      }
    });
  }, function (error) {
