...
function guardarInspeccion(){
  ...
  * ============================= */
  ...
  updateItemsAuditoriaInspeccionesAscensores(cod_usuario,codigo_inspeccion,consecutivo_inspeccion,contador_items_nocumple,'Pendiente');
}

/*=============================================
* Funcion para actualizar una fila en la tabla ascensor_valores_iniciales
*==============================================*/
function updateItemsAscensorValoresIniciales(textCliente,textEquipo,textEmpresaMantenimiento,textTipoAccionamiento,textCapacidadPersonas,textCapacidadPeso,textNumeroParadas,textFecha,textUltimoMto,textInicioServicio,textUltimaInspec,hora,tipo_informe, k_codusuario,k_codinspeccion) {
  db.transaction(function (tx) {
    var query = "UPDATE ascensor_valores_iniciales SET n_cliente = ?,"+
                                                      ...
                                                      "WHERE k_codusuario = ? "+
                                                      "AND k_codinspeccion = ?";
    tx.executeSql(query, [textCliente,textEquipo,textEmpresaMantenimiento,textTipoAccionamiento,textCapacidadPersonas,textCapacidadPeso,textNumeroParadas,textFecha,textUltimoMto,textInicioServicio,textUltimaInspec,hora,tipo_informe, k_codusuario,k_codinspeccion], function(tx, res) {
...
*==============================================*/
function updateItemsAuditoriaInspeccionesAscensores(k_codusuario,cod_inspeccion,consecutivo_insp,revision,estado_envio) {
  ...
  db.transaction(function (tx) {
    ...
    tx.executeSql(query, [estado_envio,estado_revision,revision,k_codusuario,cod_inspeccion,consecutivo_insp], function(tx, res) {
