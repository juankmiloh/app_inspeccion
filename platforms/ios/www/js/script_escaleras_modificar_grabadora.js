...
function onCopySuccessAudio(entry) {
  ...
  addItemsEscalerasValoresAudios();
  //ObtenerCantidadItemsAVA();
  //getDataEscalerasValoresAudios();
...
*==============================================*/
function addItemsEscalerasValoresAudios() {
...
/*=============================================
* Funcion en donde se cuentan las filas de la tabla escaleras_valores_audios [AVA]
*==============================================*/
/*function ObtenerCantidadItemsAVA(){
  db.transaction(function (tx) {
    var query = "SELECT COUNT(*) AS c FROM escaleras_valores_audios";
    tx.executeSql(query, [], function (tx, resultSet) {
      console.log('Numero de filas tabla escaleras_valores_audios -> '+resultSet.rows.item(0).c);
    },
    function (tx, error) {
...
/*=============================================
* Funcion para hacer un select a la tabla escaleras_valores_audios
*==============================================*/
/*function getDataEscalerasValoresAudios() {
  db.transaction(function (tx) {
    var query = "SELECT k_codusuario,k_codinspeccion,n_audio,n_directorio FROM escaleras_valores_audios";
    tx.executeSql(query, [], function (tx, resultSet) {
