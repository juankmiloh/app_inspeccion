...
$(document).ready(function(){ 
  ...
  */
  ...
  keepAwake(); //COMANDO PARA PERMITIR MANTENER LA PANTALLA DEL DISPOSITIVO ACTIVA
  //window.plugins.insomnia.allowSleepAgain(); //COMANDO PARA PERMITIR APAGAR LA PANTALLA DEL DISPOSITIVO ESPUES DE UN TIEMPO ACTIVA
