...
function cerrarVentanaCarga(){
  ...
  swal({
    ...
    type: 'success',
    html: 'Se modifico la inspección Nº. ' + consecutivo_inspeccion,
...
*==============================================*/
function updateItemsEscalerasValoresIniciales(n_cliente,n_equipo,n_empresamto,v_velocidad,o_tipo_equipo,v_inclinacion,v_ancho_paso,f_fecha,ultimo_mto,inicio_servicio,ultima_inspeccion,v_codigo,o_consecutivoinsp,h_hora,k_codusuario,k_codinspeccion) {
  ...
  db.transaction(function (tx) {
    var query = "UPDATE escaleras_valores_iniciales SET n_cliente = ?,"+
                                                       ...
                                                       "WHERE k_codusuario = ? "+
                                                       "AND k_codinspeccion = ?";
    tx.executeSql(query, [n_cliente,n_equipo,n_empresamto,v_velocidad,o_tipo_equipo,v_inclinacion,v_ancho_paso,f_fecha,ultimo_mto,inicio_servicio,ultima_inspeccion,v_codigo,o_consecutivoinsp,h_hora,k_codusuario,k_codinspeccion], function(tx, res) {
...
*==============================================*/
function updateItemsAuditoriaInspeccionesEscaleras(k_codusuario,cod_inspeccion,consecutivo_insp,revision) {
  ...
  db.transaction(function (tx) {
    var query = "UPDATE auditoria_inspecciones_escaleras SET o_revision = ?,"+
                                                          "v_item_nocumple = ? "+
                                                          "WHERE k_codusuario = ? "+
                                                          "AND k_codinspeccion = ? "+
