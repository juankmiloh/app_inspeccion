...
function llenarTablaEscalerasValoresElementos(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_escaleras_valores_elementos.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
...
function llenarTablaEscalerasValoresFinales(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_escaleras_valores_finales.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaEscalerasValoresIniciales(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_escaleras_valores_iniciales.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaEscalerasValoresDefectos(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_escaleras_valores_defectos.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaEscalerasValoresPreliminar(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_escaleras_valores_preliminar.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaEscalerasValoresProteccion(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_escaleras_valores_proteccion.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaEscalerasValoresAuditoriaEscaleras(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_escaleras_valores_auditoria_escaleras.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaEscalerasValoresCliente(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_escaleras_valores_cliente.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaEscalerasValoresInforme(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_escaleras_valores_informe.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function comprobarCambiosBD_escaleras(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_escaleras_comprobar_cambios_en_bd.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function actualizarTablaAuditoriaEscalerasServidor(k_codusuario,k_codinspeccion){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_escaleras_actualizar_valores_auditoria.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
