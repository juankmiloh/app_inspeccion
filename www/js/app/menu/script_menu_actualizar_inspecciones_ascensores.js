$(document).ready(function($){
  actualizar_inspecciones_ascensores();
});

function actualizar_inspecciones_ascensores(){
  comprobarCambiosBD_ascensores();
}
...
function llenarTablaAscensorValoresCabina(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_valores_cabina.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
...
function llenarTablaAscensorValoresElementos(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_valores_elementos.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaAscensorValoresFinales(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_valores_finales.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaAscensorValoresFoso(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_valores_foso.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaAscensorValoresIniciales(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_valores_iniciales.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaAscensorValoresMaquinas(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_valores_maquinas.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaAscensorValoresPozo(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_valores_pozo.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaAscensorValoresPreliminar(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_valores_preliminar.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaAscensorValoresProteccion(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_valores_proteccion.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablaAscensorValoresAuditoriaAscensores(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_valores_auditoria_ascensores.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
*==============================================*/
function addItemsAscensorValoresAuditoriaAscensores(k_codusuario,k_codinspeccion,o_consecutivoinsp,o_estado_envio,o_revision,v_item_nocumple,k_codcliente,k_codinforme,k_codusuario_modifica,o_actualizar_inspeccion) {
  db.transaction(function (tx) {
    var query = "INSERT INTO auditoria_inspecciones_ascensores (k_codusuario,k_codinspeccion,o_consecutivoinsp,o_estado_envio,o_revision,v_item_nocumple,k_codcliente,k_codinforme,k_codusuario_modifica,o_actualizar_inspeccion) VALUES (?,?,?,?,?,?,?,?,?,?)";
...
function llenarTablaAscensorValoresCliente(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_valores_cliente.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
        ...
        db.transaction(function (tx) {
          ...
          tx.executeSql(query, [k_codusuario,k_codcliente], function (tx, resultSet) {
            if (resultSet.rows.length == 0) {
              ...
              updateItemsAscensorValoresCliente(k_codcliente,v_consecutivocliente,k_codusuario,n_cliente,n_contacto,v_nit,o_direccion,o_telefono,o_correo);
            }
          },
          function (tx, error) {
            console.log('SELECT error: ' + error.message);
...
*==============================================*/
function updateItemsAscensorValoresCliente(k_codcliente,v_consecutivocliente,k_codusuario,n_cliente,n_contacto,v_nit,o_direccion,o_telefono,o_correo) {
  db.transaction(function (tx) {
...
function llenarTablaAscensorValoresInforme(){
  ...
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_valores_informe.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
          ...
          db.transaction(function (tx) {
            ...
            tx.executeSql(query, [k_codusuario,k_codinforme], function (tx, resultSet) {
              if (resultSet.rows.length == 0) {
                ...
                abrir_Ventana_Carga();
                updateItemsAscensorValoresInforme(k_codinforme,v_consecutivoinforme,k_codusuario,f_informe);
              }
            },
            function (tx, error) {
              console.log('SELECT error: ' + error.message);
...
*==============================================*/
function updateItemsAscensorValoresInforme(k_codinforme,v_consecutivoinforme,k_codusuario,f_informe) {
  db.transaction(function (tx) {
...
* Funcion para llenar la tabla auditoria_inspecciones_ascensores, trayendo del servidor los items en un archivo JSON
*==============================================*/
function comprobarCambiosBD_ascensores(){
  var cod_inspector = window.localStorage.getItem("codigo_inspector");
  var parametros = {"inspector" : cod_inspector};
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_comprobar_cambios_en_bd.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
      //alert(response);
      $.each(response, function(i,item){
        var count_ascensores = item.count_ascensores;
        if (count_ascensores > 0) {
          navigator.vibrate(2500); //Hacemos vibrar el dispositivo
          message = 'Advertencia:\n\nSe han realizado cambios en las inspecciones de ascensores.\n\n¿Desea cargar estos cambios?';
          title = 'Montajes & Procesos M.P SAS';
          if(navigator.notification && navigator.notification.alert){
              navigator.notification.confirm(
              message, // message
              confirm_ascensores, // callback to invoke with index of button pressed
              title, // title
          ...
          //alert("No hay inspecciones a ser cargadas!");
          setTimeout('comprobarCambiosBD_ascensores()',10000);
        }
      });
    }
  });
...
function confirm_ascensores(buttonIndex) {
  if (buttonIndex == 1) {
    llenarTablas_ascensores();
    setTimeout('comprobarCambiosBD_ascensores()',1000);
  }
...
/*=============================================
* Funcion para actualizar el campo de o_actualizar_inspeccion (por No) de la tabla de auditoria_inspecciones_ascensores del servidor luego de que se 
...
*==============================================*/
function actualizarTablaAuditoriaAscensorServidor(k_codusuario,k_codinspeccion){
  var parametros = {"inspector" : k_codusuario, "inspeccion" : k_codinspeccion, "o_actualizar_inspeccion" : 'No'};
  $.ajax({
    async:  true,
    url: "http://192.168.0.23:8888/inspeccion/servidor/php/json_app_ascensor_actualizar_valores_auditoria.php",
    data: parametros,
    type: "POST",
    dataType : "JSON",
    success: function(response){
...
function llenarTablas_ascensores() {
  llenarTablaAscensorValoresInforme(); //Se abre la ventana de carga
  llenarTablaAscensorValoresAuditoriaAscensores(); 
