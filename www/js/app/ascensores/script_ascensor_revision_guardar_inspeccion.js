...
*==============================================*/
function updateItemsAuditoriaInspeccionesAscensores(k_codusuario,cod_inspeccion,consecutivo_insp,revision,estado_envio,o_actualizar_inspeccion) {
  ...
  db.transaction(function (tx) {
    var query = "UPDATE auditoria_inspecciones_ascensores SET o_actualizar_inspeccion = ?,"+
                                                              "o_estado_envio = ?,"+
                                                              "o_revision = ?,"+
                                                              "v_item_nocumple = ? "+
                                                              "WHERE k_codusuario = ? "+
