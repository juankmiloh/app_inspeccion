...
function llenarTablaAscensorItemsCabina(){
  var url="http://www.montajesyprocesos.com/inspeccion/servidor/php/json_ascensor_items_cabina.php";
...
function llenarTablaAscensorItemsFoso(){
  var url="http://www.montajesyprocesos.com/inspeccion/servidor/php/json_ascensor_items_foso.php";
...
function llenarTablaAscensorItemsMaquinas(){
  var url="http://www.montajesyprocesos.com/inspeccion/servidor/php/json_ascensor_items_maquinas.php";
...
function llenarTablaAscensorItemsPozo(){
  var url="http://www.montajesyprocesos.com/inspeccion/servidor/php/json_ascensor_items_pozo.php";
...
function llenarTablaAscensorItemsPreliminar(){
  var url="http://www.montajesyprocesos.com/inspeccion/servidor/php/json_ascensor_items_preliminar.php";
...
function llenarTablaAscensorItemsProteccion(){
  var url="http://www.montajesyprocesos.com/inspeccion/servidor/php/json_ascensor_items_proteccion.php";
...
function llenarTablaAscensorItemsElementos(){
  var url="http://www.montajesyprocesos.com/inspeccion/servidor/php/json_ascensor_items_elementos.php";
